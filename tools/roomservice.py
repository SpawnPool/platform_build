...
if not depsonly:
    print "Device %s not found. Attempting to retrieve device repository from SpawnPoolGithub (http://github.com/SpawnPool)." % device

repositories = []

page = 1
while not depsonly:
    result = json.loads(urllib2.urlopen("http://github.com/api/v2/json/repos/show/SpawnPool=%d" % page).read())
